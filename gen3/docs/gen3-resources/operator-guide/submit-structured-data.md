...
After creating a data dictionary you are ready to submit structured data. These data are submitted in tab-separated value (TSV) files for each node in the project, which can be downloaded from the "Dictionary" page of the data commons website. (e.g. [Gen3 Data Hub](https://gen3.datacommons.io/DD).
...
![Template](/gen3-resources/operator-guide/img/Gen3_Dictionary_Subject_template_2020.png)

## The order of node submission is important
...
2. Click on "Submit Data" in the top navigation bar.
    ...
    ![Data Submission](/gen3-resources/operator-guide/img/Gen3_Toolbar_data_submission.png)
...
4. Click on "Upload File".
    ...
    ![Upload and Submit](/gen3-resources/operator-guide/img/Gen3_Data_Submission_Use_Form.png)
...
Templates can be downloaded from the data dictionary page of your commons.  See the [Gen3 Data Hub](https://gen3.datacommons.io/DD) as an example and click on the TSV option for each node.
...
![Node Information](/gen3-resources/operator-guide/img/Gen3_Model_node_view.png)
