...
## 1. Project Creation, Upload of Files, and Mapping Files

Contribution of data files can be performed with either the [Gen3 GUI](https://gen3.org/resources/user/gui-submission) or [Gen3 DIIRM workflow](https://gen3.org/resources/user/diirm-submission).  Once data files have been uploaded and mapped according to either of these two processes, the following steps can be initiated.
